...
(self.webpackChunkelementor = self.webpackChunkelementor || []).push([
    [723], {
        5626: (e, t, n) => {
            ...
            const o = new(i(n(4508)).default)("eicon"),
                s = {
                    get element() {
                        return o.createSvgElement("chevron-left", {
            ...
            const r = {
                get element() {
                    return o.createSvgElement("chevron-right", {
            ...
            const a = {
                get element() {
                    return o.createSvgElement("download-bold", {
            ...
            const d = {
                get element() {
                    return o.createSvgElement("facebook", {
            ...
            const c = {
                get element() {
                    return o.createSvgElement("frame-expand", {
            ...
            const h = {
                get element() {
                    return o.createSvgElement("frame-minimize", {
            ...
            const m = {
                get element() {
                    return o.createSvgElement("loading", {
            ...
            const p = {
                get element() {
                    return o.createSvgElement("pinterest", {
            ...
            const u = {
                get element() {
                    return o.createSvgElement("share-arrow", {
            ...
            const g = {
                get element() {
                    return o.createSvgElement("twitter", {
            ...
            const v = {
                get element() {
                    return o.createSvgElement("zoom-in-bold", {
            ...
            const w = {
                get element() {
                    return o.createSvgElement("zoom-out-bold", {
        ...
        4508: (e, t, n) => {
            ...
            class IconsManager {
                ...
                createSvgNode(e, t) {
                    ...
                    return Object.keys(n).map((e => o[e] = n[e])), Object.keys(i).map((e => o.setAttributeNS(null, e, i[e]))), o
                }
        ...
        3896: (e, t, n) => {
            ...
            e.exports = elementorModules.ViewModule.extend({
                ...
                showModal(e) {
                    ...
                    const o = t.getModal();
                    switch (o.setID(t.getSettings("modalOptions.id")), o.onShow = function() {
                        DialogsManager.getWidgetType("lightbox").prototype.onShow.apply(o, arguments), t.setEntranceAnimation()
                    }, o.onHide = function() {
                        DialogsManager.getWidgetType("lightbox").prototype.onHide.apply(o, arguments), o.getElements("message").removeClass("animated"), i.default.isFullscreen && t.deactivateFullscreen(), t.unbindHotKeys()
                    }, e.type) {
                        case "video":
                            t.setVideoContent(e);
                            break;
                ...
                setVideoContent(e) {
                    ...
                    if ("hosted" === e.videoType) {
                        ...
                        n = t("<iframe>", {
                            allowfullscreen: 1
                        }), "yes" === e.autoplay ? (n.attr("allow", "autoplay"), n.attr("src", i.getAutoplayURL(e.url))) : n.attr("src", e.url)
                    }
                    const i = this.getSettings("classes"),
                        o = this.getRatioDictionry(this.getSettings("modalOptions.videoAspectRatio")),
                        s = t("<div>", {
                            class: `${i.videoContainer} ${i.preventClose}`
                        }),
                        r = t("<div>", {
                            class: `${i.videoWrapper} elementor-video-${this.getRatioType(o)}`,
                            style: "--video-aspect-ratio: " + o
                        });
                ...
                getShareLinks() {
                    ...
                    }, n = jQuery, i = this.getSettings("classes"), s = this.getSettings("selectors"), r = n("<div>", {
                        class: i.slideshow.shareLinks
                    }), l = this.getSlide("active"), a = l.find(s.image), d = l.data("elementor-slideshow-video");
                    let c;
                    if (c = d || a.attr("src"), n.each(t, ((e, t) => {
                            const i = t.label,
                                ...
                                s = this.isFontIconSvgExperiment ? n(t.iconElement.element) : n("<i>", {
                                    class: "eicon-" + e,
                                    "aria-hidden": "true"
                                });
                            o.prepend(s), r.append(o)
                        })), !d) {
                        const t = this.isFontIconSvgExperiment ? n(o.downloadBold.element) : n("<i>", {
                ...
                getSlideshowHeader() {
                    const {
                        i18n: e
                    } = elementorFrontend.config, t = jQuery, n = "yes" === elementorFrontend.getKitSettings("lightbox_enable_counter"), i = "yes" === elementorFrontend.getKitSettings("lightbox_enable_fullscreen"), s = "yes" === elementorFrontend.getKitSettings("lightbox_enable_zoom"), r = "yes" === elementorFrontend.getKitSettings("lightbox_enable_share"), l = this.getSettings("classes"), a = l.slideshow, d = this.elements;
                    if (n || i || s || r) {
                        if (d.$header = t("<header>", {
                                class: a.header + " " + l.preventClose
                            }), r) {
                            const n = this.isFontIconSvgExperiment ? o.shareArrow.element : "<i>";
                            d.$iconShare = t(n, {
                                class: a.iconShare,
                                role: "button",
                                tabindex: 0,
                        ...
                        if (s) {
                            const n = this.isFontIconSvgExperiment ? o.zoomInBold.element : "<i>",
                                i = [],
                                s = {
                                    role: "switch",
                                    tabindex: 0,
                            ...
                            this.isFontIconSvgExperiment || (r.class = a.iconZoomIn), d.$iconZoom = t(n).attr(r).on("click", this.toggleZoomMode), i.push(d.$iconZoom), this.isFontIconSvgExperiment && (d.$iconZoomOut = t(o.zoomOutBold.element).attr(s).addClass(l.hidden).on("click", this.toggleZoomMode), i.push(d.$iconZoomOut)), d.$header.append(i), this.$buttons = this.$buttons.add(i)
                        }
                        if (i) {
                            const n = this.isFontIconSvgExperiment ? o.frameExpand.element : "<i>",
                                i = [],
                                s = {
                                    role: "switch",
                                    tabindex: 0,
                            ...
                            this.isFontIconSvgExperiment || (r.class = a.iconExpand), d.$iconExpand = t(n).append(t("<span>"), t("<span>")).attr(r).on("click", this.toggleFullscreen), i.push(d.$iconExpand), this.isFontIconSvgExperiment && (d.$iconMinimize = t(o.frameMinimize.element).attr(s).addClass(l.hidden).on("click", this.toggleFullscreen), i.push(d.$iconMinimize)), d.$header.append(i), this.$buttons = this.$buttons.add(i)
                        }
                ...
                setSlideshowContent(e) {
                    const {
                        i18n: t
                    } = elementorFrontend.config, n = jQuery, i = 1 === e.slides.length, s = "" !== elementorFrontend.getKitSettings("lightbox_title_src"), r = "" !== elementorFrontend.getKitSettings("lightbox_description_src"), l = s || r, a = this.getSettings("classes"), d = a.slideshow, c = n("<div>", {
                        class: d.container
                    }), h = n("<div>", {
                    ...
                    if (e.slides.forEach((e => {
                            ...
                            if (e.video) {
                                ...
                                const i = this.isFontIconSvgExperiment ? o.loading.element : "<i>",
                                    r = n("<div>", {
                                        class: a.playButton
                                ...
                                const r = n("<img>", o);
                                t.append([r, i]), s.append(t)
                            }
                            e.hash && s.attr("data-e-action-hash", e.hash), h.append(s)
                        })), this.elements.$container = c, this.elements.$header = this.getSlideshowHeader(), c.prepend(this.elements.$header).append(h), !i) {
                        const e = this.isFontIconSvgExperiment ? n(o.chevronLeft.element) : n("<i>", {
                                class: d.prevButtonIcon,
                                "aria-hidden": "true"
                            }),
                            i = this.isFontIconSvgExperiment ? n(o.chevronRight.element) : n("<i>", {
                    ...
                    u.onShow = async () => {
                        ...
                        this.swiper = await new o(c, t), c.data("swiper", this.swiper), this.playSlideVideo(), l && this.updateFooterText(), this.bindHotKeys(), this.makeButtonsAccessible()
                    }
                },
                ...
                activeKeyDown(e) {
                    ...
                    if (9 === e.which) {
                        ...
                        t.each((e => {
                            const s = t[e];
                            if (jQuery(s).is(":focus")) return n = s, i = 0 === e, o = t.length - 1 === e, !1
                        })), e.shiftKey ? i && (e.preventDefault(), t.last().trigger("focus")) : !o && n || (e.preventDefault(), t.first().trigger("focus"))
                    }
                },
                getSlide(e) {
                ...
                updateFooterText() {
                    ...
                    const e = this.getSettings("classes"),
                        ...
                        s = this.elements.$footer.find("." + e.slideshow.description);
                    o.text(n || ""), s.text(i || "")
                },
                playSlideVideo() {
                    ...
                    let l, a;
                    o.append(s), e.append(o), -1 !== t.indexOf("vimeo.com") ? (l = "vimeo", a = elementorFrontend.utils.vimeo) : t.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && (l = "youtube", a = elementorFrontend.utils.youtube);
                    const d = a.getVideoIDFromURL(t);
                    a.onApiReady((e => {
                        "youtube" === l ? this.prepareYTVideo(e, d, o, s, r) : "vimeo" === l && this.prepareVimeoVideo(e, t, o, s, r)
                    })), r.addClass(n.playing).removeClass(n.hidden)
                },
                prepareYTVideo(e, t, n, i, o) {
                    const s = this.getSettings("classes"),
                        r = jQuery("<div>");
                    let l = e.PlayerState.PLAYING;
                    i.append(r), window.chrome && (l = e.PlayerState.UNSTARTED), n.addClass("elementor-loading " + s.invisible), this.player = new e.Player(r[0], {
                        videoId: t,
                        events: {
                            onReady: () => {
                                o.addClass(s.hidden), n.removeClass(s.invisible), this.player.playVideo()
                            },
                            onStateChange: e => {
                ...
                prepareVimeoVideo(e, t, n, i, o) {
                    ...
                    this.player = new e.Player(i, r), this.player.ready().then((() => {
                        o.addClass(s.hidden), n.removeClass(s.invisible)
                    }))
                },
                ...
                openSlideshow(e, t) {
                    ...
                    n.each((function() {
                        ...
                        let s = this.dataset.elementorLightboxIndex;
                        void 0 === s && (s = n.index(this)), (t === this.href || e && t === e) && (o = s);
                        const r = {
                            image: this.href,
                            index: s,
                ...
                var t = "undefined" != typeof window && void 0 !== window.document ? window.document : {},
                    ...
                    i = function() {
                        for (var e, n = [
                            ...
                            ], i = 0, o = n.length, s = {}; i < o; i++)
                            if ((e = n[i]) && e[1] in t) {
                                var r = e.length;
                                for (i = 0; i < r; i++) s[n[0][i]] = e[i];
                                return s
                            }
                        return !1
                    }(),
                    ...
                    s = {
                        request(e) {
                            return new Promise(function(n, o) {
                                ...
                                this.on("change", s), e = e || t.documentElement, Promise.resolve(e[i.requestFullscreen]()).catch(o)
                            }.bind(this))
                        },
                        exit() {
