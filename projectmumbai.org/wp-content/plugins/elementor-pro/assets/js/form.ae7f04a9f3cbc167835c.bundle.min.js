        ...
        2176: (e, t) => {
            ...
            t.default = elementorModules.frontend.handlers.Base.extend({
                ...
                onSuccess(e) {
                    ...
                    if (this.elements.$submitButton.removeAttr("disabled").find(".elementor-form-spinner").remove(), t.animate({
                            opacity: "1"
                        }, 100).removeClass("elementor-form-waiting"), e.success) {
                        t.trigger("submit_success", e.data), t.trigger("form_destruct", e.data), t.trigger("reset");
                        let s = "elementor-message elementor-message-success";
                        elementorFrontendConfig.experimentalFeatures.e_font_icon_svg && (s += " elementor-message-svg"), void 0 !== e.data.message && "" !== e.data.message && t.append('<div class="' + s + '" role="alert">' + e.data.message + "</div>")
                    } else e.data.errors && (jQuery.each(e.data.errors, (function(e, s) {
        ...
        9230: (e, t) => {
            ...
            class FormSteps extends elementorModules.frontend.handlers.Base {
                ...
                goToStep(e) {
                    ...
                    this.elements.$stepWrapper.eq(this.state.currentStep).addClass(t.hidden), this.elements.$stepWrapper.eq(e).removeClass(t.hidden);
                    const s = this.getFirstFocusableField(e);
                    s && (s.attr("tabindex", "0"), s.trigger("focus"))
                }
                getFirstFocusableField(e) {
                    const t = this.elements.$stepWrapper.eq(e).children(this.getSettings("selectors.fieldGroup"));
                    let s = null;
                    return t.each(((e, t) => {
                        const r = jQuery(t),
                            i = this.getFocusableElement(r);
                        if (i) return s = i, !1
                    })), s
                }
                getFocusableElement(e) {
                    if (!e.is(":visible")) return;
                    const t = e.find(":input").first();
                    return !!t.length ? t : e
                }
                isFieldsValid(e) {
                    let t = !0;
