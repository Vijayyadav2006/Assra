(function() {
    ...
    */
    ...
    q(chrome.cast.media.ja, chrome.cast.media.MediaMetadata);
    ...
    q(chrome.cast.media.ma, chrome.cast.media.MediaMetadata);
    ...
    q(chrome.cast.media.Aa, chrome.cast.media.MediaMetadata);
    ...
    q(chrome.cast.media.fa, chrome.cast.media.S);
    ...
    var Ua = function(a, b, c, d, e, h, k, m, p, t) {
        ...
        Va = function(a) {
            ...
            a.i && b.push(Ta(new Sa(a.i, a.F, a.g)));
            return b
        };
    var Wa = function() {
            this.g = {};
        ...
        Ya = function(a, b) {
            ...
            if (a.playerState == chrome.cast.media.A.IDLE && a.loadingItemId == null) a.currentItemId = null, a.loadingItemId = null, a.preloadedItemId = null, a.items = null;
                ...
                for (h = b.next(); !h.done; h = b.next()) {
                    ...
                    m = k.push;
                    var p = void 0,
                        t = new chrome.cast.media.sa(h.media);
    ...
    var V = function() {
        ...
        W = function(a, b, c, d) {
            ...
            d = Ra(a.B, b);
            c && d && (a = Qa(a.R, b.sequenceNumber)) && (a = a.g, d = new chrome.cast.Error(chrome.cast.v.INVALID_PARAMETER,
                d), a && a(d))
        };
    ...
    var Y = function(a, b, c) {
        ...
        b.onclose = function(d) {
            ...
            switch (d.reason) {
                case "closed":
                    gb(a, chrome.cast.J.DISCONNECTED);
                    break;
                case "error":
                    if (c) {
                        d = c;
    ...
    var X = function(a, b) {
        ...
        return Va(new Ua(h, a.B.i, a.g.autoJoinPolicy, a.g.defaultActionPolicy, b.requestSessionTimeout, c, d, a.g.invisibleSender, b.androidReceiverCompatible, b.credentialsData))
    };
    ...
    f.ba = function(a) {
        var b = this;
        (new PresentationRequest(X(this))).reconnect(chrome.cast.bb + a).then(function(c) {
            Y(b, c)
        }, function() {})
    };
    ...
    var gb = function(a, b) {
        if (a.F) {
            ...
            Xa(a.I, c, b) && (a.s.delete(c), a.G.delete(c), b = a.C.get(c)) && (a.C.delete(c), G(b.o(), function(e) {
                e(d)
            }))
        }
    };
    V.prototype.onMessage = function(a) {
        switch (a.type) {
            case "new_session":
            case "update_session":
                a.message = Za(this.I, a.message);
                break;
            case "v2_message":
                var b = a.message;
                b && b.type == "MEDIA_STATUS" && b.status && (b.status = b.status.map(this.La))
        }
        if (b = Qa(this.R, a.sequenceNumber)) a.type == "error" ? (b = b.g) && b(a.message) : (b = b.l) && b(a.message);
    ...
    var lb = function(a, b) {
            (a = a.C.get(b.sessionId)) && G(a.o(), function(c) {
                c(!0)
            })
        },
        kb = function(a, b) {
        ...
        mb = function(a, b) {
            (a = a.s.get(b.sessionId)) && (a = a.get(b.namespaceName)) && G(a.o(), function(c) {
