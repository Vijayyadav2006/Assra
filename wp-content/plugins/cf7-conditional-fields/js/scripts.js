...
const wpcf7cf_show_step_animation = {
    "opacity": "show"
};
const wpcf7cf_hide_step_animation = {
    "opacity": "hide"
};
    ...
    updateRepeaterSubHTML: function(html, oldSuffix, newSuffix, parentRepeaters) {
        ...
        if (
            ...
            const parentRepeatersInfo = parentRepeaters.map((repeaterId, i) => {
                return {
                    [repeaterId.split('__')[0]]: [oldIndexes[i], newIndexes[i]]
                };
            });
