(function() {
    ...
    r("Promise", function(a) {
        ...
        b.prototype.v = function(h, g) {
            if (this.h != 0) throw Error("Cannot settle(" + h + ", " + g + "): Promise already settled in state" + this.h);
            this.h = h;
            this.i = g;
            this.h === 2 && this.J();
            this.R()
        ...
        b.prototype.S = function() {
            ...
            typeof h === "function" ? h = new h("unhandledrejection", {
                ...
                cancelable: !0
            }) : (h = q.document.createEvent("CustomEvent"), h.initCustomEvent("unhandledrejection", !1, !0, h));
            h.promise = this;
            h.reason = this.i;
            return k(h)
        };
        b.prototype.R = function() {
            if (this.g != null) {
                for (var h = 0; h < this.g.length; ++h) e.h(this.g[h]);
                this.g = null
            }
        };
        var e = new c;
        ...
        b.race = function(h) {
            return new b(function(g, k) {
                for (var l = x(h), m = l.next(); !m.done; m = l.next()) d(m.value).A(g, k)
            })
        };
        b.all = function(h) {
            var g = x(h),
            ...
            return k.done ? d([]) : new b(function(l, m) {
                ...
                var w = [],
                    A = 0;
                do w.push(void 0), A++, d(k.value).A(u(w.length - 1), m), k = g.next(); while (!k.done)
            })
        };
        return b
    });
    ...
    r("WeakMap", function(a) {
        ...
        b.prototype.set = function(k, l) {
            ...
            f(k);
            if (!F(k, h)) throw Error("WeakMap key fail: " + k);
            k[h][this.g] = l;
            return this
        };
    ...
    r("Map", function(a) {
        ...
        function d(g, k) {
            var l = k && typeof k;
            l == "object" || l == "function" ? e.has(k) ? l = e.get(k) : (l = "" + ++h, e.set(k, l)) : l = "p_" + k;
            var m = g[0][l];
            if (m && F(g[0], l))
        ...
        f.prototype.delete = function(g) {
            g = d(this, g);
            return g.entry && g.list ? (g.list.splice(g.index, 1), g.list.length || delete this[0][g.id], g.entry.previous.next = g.entry.next, g.entry.next.previous = g.entry.previous, g.entry.head = null, this.size--, !0) : !1
        };
        ...
        f.prototype.forEach = function(g, k) {
            for (var l = this.entries(), m; !(m = l.next()).done;) m = m.value, g.call(k, m[1], m[0], this)
        };
    ...
    r("Array.from", function(a) {
        return a ? a : function(b, c, d) {
            ...
            if (typeof e == "function") {
                b = e.call(b);
                for (var h = 0; !(e = b.next()).done;) f.push(c.call(d, e.value, h++))
            } else
                for (e = b.length, h = 0; h < e; h++) f.push(c.call(d, b[h], h));
            return f
        }
    });
    /*
    ...
    */
    ...
    function I(a, b) {
        a = a.split(".");
        for (var c = G, d; a.length && (d = a.shift());) a.length || b === void 0 ? c[d] && c[d] !== Object.prototype[d] ? c = c[d] : c = c[d] = {} : c[d] = b
    }
    ...
    */
    ...
    function fb() {
        ...
        else b = (R().indexOf("Chrome") != -1 || R().indexOf("CriOS") != -1) && (db() || R().indexOf("Edge") == -1) || R().indexOf("Silk") != -1;
    ...
    n.F = function(a, b) {
        ...
        if (c) {
            var d = Array(arguments.length - 1),
                f = arguments.length,
                e;
            for (e = 1; e < f; e++) d[e - 1] = arguments[e];
            if (this.v)
                for (e = 0; e < c.length; e++) f = c[e], jb(this.g[f + 1], this.g[f + 2], d);
            else {
                this.m++;
                try {
                    for (e = 0, f = c.length; e < f && !this.i; e++) {
                        var h = c[e];
                        this.g[h + 1].apply(this.g[h + 2], d)
                    }
                } finally {
                    if (this.m--, this.l.length > 0 && this.m == 0)
                        for (; c = this.l.pop();) this.C(c)
                }
            }
            return e != 0
        }
    ...
    n.clear = function(a) {
        if (a) {
            var b = this.h[a];
            b && (b.forEach(this.C, this), delete this.h[a])
    ...
    function mb(a, b, c) {
        if (Array.isArray(b))
            for (var d = 0; d < b.length; d++) mb(a, String(b[d]), c);
                ...
                case 2:
                    ...
                    return C(c, Promise.all(b.map(function(d) {
                        ...
                        return oa(function(e) {
                            if (e.g == 1) return e.l = 2, C(e, navigator.permissions.query({
                                name: "top-level-storage-access",
                                requestedOrigin: d
                            }), 4);
                            e.g != 2 ? (f = e.m, f.state === "prompt" && a.g.push(d), e.g = 0, e.l = 0) : (e.l = 0, e.i = null, e.g = 0)
                        })
                    })), 4);
                case 4:
    ...
    function ub() {
        for (var a = x(sb), b = a.next(); !b.done; b = a.next()) b = b.value, b()
    }
    ...
    function X(a, b) {
        ...
        if (a = typeof a === "string" ? c.getElementById(a) : a) {
            ...
            c || (W.yt_embedsEnableAutoplayAndVisibilitySignals ? (b = document.createElement("iframe"), zb(this, b, a), this.i = a, hb(b, a), Ab(this, b, Bb(this, b)), a = b) : (b = document.createElement("iframe"), zb(this, b, a), Ab(this, b, Bb(this)), this.i = a, hb(b, a), a = b));
            this.g = a;
            ...
            if (window.postMessage) {
                ...
                a = Y(this,
                    "events");
                for (var f in a) a.hasOwnProperty(f) && this.addEventListener(f, a[f]);
                for (var e in tb) tb.hasOwnProperty(e) && Db(this, e)
            }
        }
    }
    n = X.prototype;
    ...
    function Ab(a, b, c) {
        ...
        var d = [],
            f;
        for (f in c) mb(f, c[f], d);
        c = a + d.join("&");
        if (W.yt_embedsEnableIframeSrcWithIntent) {
            var e = e === void 0 ? Ua : e;
            a: if (e = e === void 0 ? Ua : e, c instanceof K) e = c;
                else {
                    for (f = 0; f < e.length; ++f)
                        if (a = e[f], a instanceof Ta && a.P(c)) {
                            e = new K(c);
                            break a
                        }
                    e = void 0
            ...
            for (f = 0; f < c.length; f++) b.sandbox.supports && !b.sandbox.supports(c[f]) || b.sandbox.add(c[f]);
            if (e instanceof K)
                if (e instanceof K) e = e.g;
                else throw Error("");
    ...
    function Eb(a, b) {
        a.v[b] || (a.v[b] = !0, Fb(a, "addEventListener", [b]))
    }
    ...
    function Bb(a, b) {
        ...
        window.location.href && va(["debugjs", "debugcss"], function(f) {
            ...
            b: {
                var g = 0;
                for (var k = f.length;
                    (g = e.indexOf(f, g)) >= 0 && g < h;) {
                    var l = e.charCodeAt(g - 1);
                    if (l == 38 || l == 63)
                        if (l = e.charCodeAt(g + k), !l || l == 61 || l == 38 || l == 35) break b;
                    g += k + 1
                }
                g = -1
            }
        ...
        W.yt_embedsEnableIframeApiSendFullEmbedUrl && (window.location.href && (c.forigin = window.location.href), a = window.location.ancestorOrigins, c.aoriginsup = a === void 0 ? 0 : 1, a && a.length > 0 && (c.aorigins = Array.from(a).join(",")), window.document.referrer && (c.gporigin = window.document.referrer));
    ...
    function Kb(a, b) {
        ...
        for (var c = b.next(), d = {}; !c.done; d = {
                s: void 0
            }, c = b.next()) d.s = c.value, a[d.s] || (d.s === "getCurrentTime" ? a[d.s] = function() {
    ...
    n.getOption = function(a, b) {
        if (this.u.namespaces && a && b && this.u[a]) return this.u[a][b]
    };
    ...
    function Hb(a, b, c) {
        Z || (Z = {}, Lb = new Set, Nb.addEventListener("message", function(d) {
            a: if (Lb.has(d.origin)) {
                ...
                var e = Z[f.id];
                if (e && d.origin === e.M) switch (d = e.T, d.m = !0, d.m && (va(d.l, d.sendMessage, d), d.l.length = 0), e = f.event, f = f.info, e) {
                    case "apiInfoDelivery":
                        if (H(f))
                            for (var h in f) f.hasOwnProperty(h) && (d.u[h] = f[h]);
                        break;
                    case "infoDelivery":
                        Jb(d, f);
                        break;
                    case "initialDelivery":
                        H(f) && (clearInterval(d.h), d.playerInfo = {}, d.u = {}, Kb(d, f.apiInterface), Jb(d, f));
                        break;
                    default:
                        d.j.i ||
                            (h = {
